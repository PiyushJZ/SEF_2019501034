...
public class UserInterface {
	...
	// Group attributes for the accordion.
	Group rootMain;
	Group rootPopUp;
	Scene sceneMain;
	Scene scenePopUp;
	...
	TitledPane mass, length, time, speed, acceleration; //panes for accordion
	ObservableList<Button> unitsMass = FXCollections.observableArrayList();
	ObservableList<Button> unitsLength = FXCollections.observableArrayList();
	ObservableList<Button> unitsTime = FXCollections.observableArrayList();
	ObservableList<Button> unitsSpeed = FXCollections.observableArrayList();
	ObservableList<Button> unitsAcceleration = FXCollections.observableArrayList();
    ...
    private static Button unitButton1 = new Button("Unit");
    ...
    private static Button unitButton2 = new Button("Unit");
	...
	// All the units available.
	Button unitCode00 = createButton ("- no word selected - ", 0);
	Button unitMass02 = createButton ("Kg", 1);
	Button unitMass03 = createButton ("lbs", 2);
	Button unitMass04 = createButton ("g", 3);
	Button unitMass05 = createButton ("mg", 4);

	Button unitLength01 = createButton ("Km", 5);
	Button unitLength01 = createButton ("mi", 6);
	Button unitLength01 = createButton ("m", 7);
	Button unitLength01 = createButton ("cm", 8);
	Button unitLength01 = createButton ("mm", 9);

	Button unitTime01 = createButton ("hr", 10);
	Button unitTime02 = createButton ("min", 11);
	Button unitTime03 = createButton ("s", 12);

	Button unitSpeed01 = createButton ("Km/hr", 13);
	Button unitSpeed02 = createButton ("mph", 14);
	Button unitSpeed03 = createButton ("m/s", 15);

	Button unitAcceleration01 = createButton ("Km/hr\u00B2", 16);
	Button unitAcceleration02 = createButton ("m/s\u00B2", 17);
	...
	private Button createButton(String unitName, int unitCode) {

...
public class ErrorTermRecognizer {
	...
	public static String errorTermInput = "";
	public static int errorTermIndexofError = -1;
	...
	public static String checkErrorTerm(String input) {
		...
		case 1:
			...
			if (currentCharNdx<input.length()) {
				...
				// forward.
				errorTermErrorMessage = "This character may only be an \"E\", an \"e\", a 0, "
		...
		case 2:
			if (currentCharNdx<input.length()) {
				errorTermErrorMessage = "This character may only be an \"E\", an \"e\", or it must be the end of the input.\n";
				return errorTermErrorMessage + displayInput(input, currentCharNdx);
			} else {
				errorTermIndexofError = -1;
				errorTermErrorMessage = "";
		...
		case 8:
			errorTermErrorMessage = "This character may only be a \".\" character.\n";
			return errorTermErrorMessage + displayInput(input, currentCharNdx);
